...
class rnnCapsule(object):
    def __init__(self,
        ...
        self.model = EncoderRNN(dim_input, dim_hidden, dim_label, dim_caps, n_layers, n_label, len(vocab), 
                embed_dropout_rate, cell_dropout_rate, final_dropout_rate, embed, bidirectional, rnn_type, use_cuda, model_name)
        if self.use_cuda:
            self.model.cuda()
